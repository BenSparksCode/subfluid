...
contract LensPeriphery {
    ...
    bytes32 internal constant SET_PROFILE_METADATA_WITH_SIG_TYPEHASH =
        keccak256("SetProfileMetadataURIWithSig(uint256 profileId,string metadata,uint256 nonce,uint256 deadline)");
     ...
     */
    function setProfileMetadataURIWithSig(DataTypes.SetProfileMetadataWithSigData calldata vars) external {
        unchecked {
