...
export interface RevertFollowModuleInterface extends utils.Interface {
  contractName: "RevertFollowModule";
  functions: {
...
export interface RevertFollowModule extends BaseContract {
  contractName: "RevertFollowModule";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RevertFollowModuleInterface;
